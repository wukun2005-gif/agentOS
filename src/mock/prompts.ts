 ...
 *
 * 反例（已移除）：「今天有什么重要的」「给我一份晨间简报」「今天怎么安排」
 *   → 三条都只是 brief 的不同说法，没有体现真实摩擦。
 * 正例：「今天 8 个会，哪些其实可以不去」
 *   → 锚定 PRD §2.2.4「55% 远程工作者认为会议可用邮件替代」+ 日程过载。
 *
 * 所有文案均通过 scripts/verify-prompts.ts 校验，确保能被 IntentRouter
 * 命中到期望的 kind，不会掉进 clarifying 态。改动后请执行 `npm run verify:prompts`。
 */
...
export const PROMPT_LIBRARY: PromptGroup[] = [
  {
    ...
    items: [
      { label: '今天有什么必须我拍板的？', text: '今天有什么必须我拍板的？' },
      { label: '帮我安排一下今天的日程', text: '帮我安排一下今天的日程' },
      { label: '早上好，昨晚有什么紧急的？', text: '早上好，昨晚有什么紧急的' },
      { label: '今天 8 个会，哪些可以不去？', text: '今天 8 个会，哪些其实可以不去' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '哪些邮件拖了 3 天还没回？', text: '哪些邮件拖了 3 天还没回' },
      { label: '收件箱 117 封，按紧急排一下', text: '收件箱 117 封，按紧急程度排一下' },
      { label: '把不重要的邮件批量归档', text: '把不重要的邮件批量归档' },
      { label: '帮我起草一封婉拒的邮件', text: '帮我起草一封婉拒的邮件' },
    ],
  },
  {
    kind: 'meeting',
    ...
    items: [
      ...
      { label: '刚才的会哪些 action 归我？', text: '刚才的会议里哪些 action 归我' },
      { label: '准备一下 10 点的评审会', text: '准备一下10点的产品评审会', expect: 'prep' },
      { label: '这个会邮件就能说清，帮我推掉', text: '这场会议一封邮件就能说清，帮我推掉' },
      { label: '把评审会结论同步给没参会的', text: '把评审会结论同步给没参会的同学' },
    ],
  },
  {
    kind: 'message',
    ...
    items: [
      ...
      { label: '群里谁还在等我答复？', text: '群里谁还在等我答复' },
      { label: '把群里今天的结论整理成要点', text: '把群里今天的结论整理成要点' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '找一下最新版本，别给旧版', text: '找一下最新版本，别给我旧版' },
      { label: '这份 40 页文档帮我提炼要点', text: '这份 40 页的文档帮我提炼要点' },
      { label: '找一下 Q3 预算文档', text: '找一下 Q3 预算文档' },
      { label: '谁最近改过这份文档？', text: '谁最近改过这份文档' },
    ],
  },
  {
    kind: 'focus',
  ...
  },
  {
    ...
    items: [
      ...
      { label: '本周总结里标出卡住的事', text: '本周总结里帮我标出卡住的事' },
      { label: '今天做了什么？明天先干什么？', text: '今天做了什么？明天先干什么？' },
    ],
  },
  {
    kind: 'settings',
